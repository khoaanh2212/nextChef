...
;(function (app, window) {
    ...
    app.factory('PresenterHandlerCreator', Factory);
    ...
    PresenterHandlerCreator.newInstance = function(presenter, view, model) {
        return new PresenterHandlerCreator(presenter, view, model);
    };
    ...
    EventHandler.prototype.handle = function (DTO, context) {
        ...
        try {
            ...
            if (self._isPromise(response)) {
                response
                    .then(function (dto) {
                        self._handleSuccess(dto, context);
                    })
                    .catch(function (e) {
