...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollectionRecipes'
        db.create_table('colls_collection_recipes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe.Recipes'], db_column='recipes_id')),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['colls.Collection'], db_column='collection_id')),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'colls', ['CollectionRecipes'])

        # Adding unique constraint on 'CollectionRecipes', fields ['recipe', 'collection']
        db.create_unique('colls_collection_recipes', ['recipes_id', 'collection_id'])

        # Adding model 'Collection'
        db.create_table(u'colls_collection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('title1', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('title2', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ...
        db.send_create_signal(u'colls', ['Collection'])


    def backwards(self, orm):
        # Removing unique constraint on 'CollectionRecipes', fields ['recipe', 'collection']
        db.delete_unique('colls_collection_recipes', ['recipes_id', 'collection_id'])

        # Deleting model 'CollectionRecipes'
        db.delete_table('colls_collection_recipes')

        # Deleting model 'Collection'
        db.delete_table(u'colls_collection')
    ...
    models = {
        ...
        u'colls.collection': {
            ...
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['recipe.Recipes']", 'symmetrical': 'False', 'through': u"orm['colls.CollectionRecipes']", 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'title1': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'title2': ('django.db.models.fields.CharField', [], {'max_length': '16'})
        },
        u'colls.collectionrecipes': {
            'Meta': {'ordering': "['-score']", 'unique_together': "(('recipe', 'collection'),)", 'object_name': 'CollectionRecipes', 'db_table': "'colls_collection_recipes'"},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['colls.Collection']", 'db_column': "'collection_id'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipe.Recipes']", 'db_column': "'recipes_id'"}),
