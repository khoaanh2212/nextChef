...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subscription_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription_id', self.gf('django.db.models.fields.IntegerField')()),
            ('subscription_method', self.gf('django.db.models.fields.CharField')(default='stripe', max_length=255)),
            ('stripe_payment_id', self.gf('django.db.models.fields.IntegerField')()),
            ('is_active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'chefs', ['SubscriptionPayment'])

        # Adding model 'Subscription'
        db.create_table('subscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chef', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['chefs.Chefs'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['chefs.Plan'])),
            ('started_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 11, 0, 0))),
            ('period_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 11, 0, 0))),
            ('period_end', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('ended_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('canceled_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='started', max_length=255)),
            ('is_canceled_at_period_end', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'chefs', ['Subscription'])

        # Adding model 'Plan'
        db.create_table('plan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='pro', max_length=255)),
            ('interval', self.gf('django.db.models.fields.CharField')(default='monthly', max_length=255)),
            ('amount_per_month', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('amount_per_year', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
        ))
        db.send_create_signal(u'chefs', ['Plan'])

        # Adding model 'StripePayment'
        db.create_table('stripe_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plan_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'chefs', ['StripePayment'])


    def backwards(self, orm):
        # Deleting model 'SubscriptionPayment'
        db.delete_table('subscription_payment')

        # Deleting model 'Subscription'
        db.delete_table('subscription')

        # Deleting model 'Plan'
        db.delete_table('plan')

        # Deleting model 'StripePayment'
        db.delete_table('stripe_payment')
