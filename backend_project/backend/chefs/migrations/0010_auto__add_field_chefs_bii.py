...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chefs.bii'
        db.add_column('chefs', 'bii',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chefs.bii'
        db.delete_column('chefs', 'bii')
    ...
    models = {
        ...
        u'chefs.subscription': {
            ...
            'period_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 3, 0, 0)'}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['chefs.Plan']"}),
            'started_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 3, 0, 0)'}),
