...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chefs.fb_access_token'
        db.alter_column('chefs', 'fb_access_token', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Chefs.fb_user_id'
        db.alter_column('chefs', 'fb_user_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Chefs.fb_access_token'
        db.alter_column('chefs', 'fb_access_token', self.gf('django.db.models.fields.CharField')(default='', max_length=400))

        # Changing field 'Chefs.fb_user_id'
        db.alter_column('chefs', 'fb_user_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
