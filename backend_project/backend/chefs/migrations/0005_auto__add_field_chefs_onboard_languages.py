...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chefs.onboard_languages'
        db.add_column('chefs', 'onboard_languages',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chefs.onboard_languages'
        db.delete_column('chefs', 'onboard_languages')
