...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipesHasIngredients.link_recipe'
        db.add_column('recipes_has_ingredients', 'link_recipe',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipesHasIngredients.link_recipe'
        db.delete_column('recipes_has_ingredients', 'link_recipe')
