...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipes.publication_date'
        db.add_column('recipes', 'publication_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipes.publication_date'
        db.delete_column('recipes', 'publication_date')
