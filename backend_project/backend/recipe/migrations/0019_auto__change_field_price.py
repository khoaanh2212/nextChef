...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('recipe_has_ingredient', 'price',
                        self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2, default=0, blank=True, null=True))

    def backwards(self, orm):
        db.alter_column('recipe_has_ingredient', 'price',
                        self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2, default=0))
    ...
    models = {
        ...
        u'recipe.recipehasingredient': {
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True', 'null': 'True'}),
