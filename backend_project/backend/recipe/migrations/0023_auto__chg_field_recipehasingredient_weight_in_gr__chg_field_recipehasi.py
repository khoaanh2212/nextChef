...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecipeHasIngredient.weight_in_gr'
        db.alter_column('recipe_has_ingredient', 'weight_in_gr', self.gf('django.db.models.fields.DecimalField')(max_digits=17, decimal_places=6))

        # Changing field 'RecipeHasIngredient.quantity'
        db.alter_column('recipe_has_ingredient', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'RecipeHasIngredient.weight_in_gr'
        db.alter_column('recipe_has_ingredient', 'weight_in_gr', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'RecipeHasIngredient.quantity'
        db.alter_column('recipe_has_ingredient', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        u'recipe.recipehasingredient': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '8'}),
            'price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '6'}),
            'recipe_id': ('django.db.models.fields.IntegerField', [], {}),
            'text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'weight_in_gr': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '17', 'decimal_places': '6'})
        },
        u'recipe.recipehassubrecipe': {
            'Meta': {'object_name': 'RecipeHasSubrecipe', 'db_table': "'recipe_has_subrecipe'"},
            'amount': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '8'}),
            ...
            'sr_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'})
        },
        u'recipe.recipes': {
            ...
            'food_cost': ('django.db.models.fields.IntegerField', [], {'default': '25', 'max_length': '11', 'null': 'True'}),
            'gross_profit': ('django.db.models.fields.IntegerField', [], {'default': '75', 'max_length': '11', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'vat': ('django.db.models.fields.IntegerField', [], {'default': '20', 'max_length': '11', 'null': 'True'})
        },
