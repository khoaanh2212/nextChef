...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('recipe_has_ingredient', 'weight_in_gr', self.gf('django.db.models.fields.DecimalField')(max_digits=14, decimal_places=3))

        # Changing field 'RecipeHasIngredient.quantity'
        db.alter_column('recipe_has_ingredient', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))
    ...
    models = {
        ...
        'chefs.chefs': {
            ...
            'bii': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'recipe.recipehasingredient': {
            ...
            'weight_in_gr': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '14', 'decimal_places': '3'})
        },
