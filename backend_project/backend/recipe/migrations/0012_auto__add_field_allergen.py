...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.add_column('recipes', 'allergens',
                      self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))

    def backwards(self, orm):
        db.delete_column('recipes', 'allergen')
