...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RecipeHasIngredient.quantity'
        db.alter_column('recipe_has_ingredient', 'quantity', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'recipe.recipehasingredient': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2'}),
