...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipe_collection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'recipe', ['Collection'])

        # Adding M2M table for field recipes on 'Collection'
        m2m_table_name = db.shorten_name(u'recipe_collection_recipes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm[u'recipe.collection'], null=False)),
            ('recipes', models.ForeignKey(orm[u'recipe.recipes'], null=False))
        ))
        db.create_unique(m2m_table_name, ['collection_id', 'recipes_id'])


    def backwards(self, orm):
        # Deleting model 'Collection'
        db.delete_table(u'recipe_collection')

        # Removing M2M table for field recipes on 'Collection'
        db.delete_table(db.shorten_name(u'recipe_collection_recipes'))
    ...
    models = {
        ...
        u'recipe.collection': {
            ...
            'recipes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['recipe.Recipes']", 'symmetrical': 'False'}),
