...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipes.serves'
        db.add_column('recipes', 'serves',
                      self.gf('django.db.models.fields.IntegerField')(default=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Recipes.prep_time'
        db.add_column('recipes', 'prep_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipes.serves'
        db.delete_column('recipes', 'serves')

        # Deleting field 'Recipes.prep_time'
        db.delete_column('recipes', 'prep_time')
