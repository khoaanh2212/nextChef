...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RecipeHasSubrecipe'
        db.create_table('recipe_has_subrecipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('r_id', self.gf('django.db.models.fields.IntegerField')()),
            ('sr_id', self.gf('django.db.models.fields.IntegerField')()),
            ('sr_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('sr_allergens', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'recipe', ['RecipeHasSubrecipe'])


    def backwards(self, orm):
        # Deleting model 'RecipeHasSubrecipe'
        db.delete_table('recipe_has_subrecipe')
