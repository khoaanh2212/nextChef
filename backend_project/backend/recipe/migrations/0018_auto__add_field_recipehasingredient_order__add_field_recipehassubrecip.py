...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipeHasIngredient.order'
        db.add_column('recipe_has_ingredient', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=8),
                      keep_default=False)

        # Adding field 'RecipeHasSubrecipe.order'
        db.add_column('recipe_has_subrecipe', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipeHasIngredient.order'
        db.delete_column('recipe_has_ingredient', 'order')

        # Deleting field 'RecipeHasSubrecipe.order'
        db.delete_column('recipe_has_subrecipe', 'order')
