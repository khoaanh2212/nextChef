...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RecipeHasSubrecipe.amount'
        db.add_column('recipe_has_subrecipe', 'amount',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Recipes.gross_profit'
        db.add_column('recipes', 'gross_profit',
                      self.gf('django.db.models.fields.IntegerField')(max_length=11, null=True),
                      keep_default=False)

        # Adding field 'Recipes.food_cost'
        db.add_column('recipes', 'food_cost',
                      self.gf('django.db.models.fields.IntegerField')(max_length=11, null=True),
                      keep_default=False)

        # Adding field 'Recipes.vat'
        db.add_column('recipes', 'vat',
                      self.gf('django.db.models.fields.IntegerField')(max_length=11, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RecipeHasSubrecipe.amount'
        db.delete_column('recipe_has_subrecipe', 'amount')

        # Deleting field 'Recipes.gross_profit'
        db.delete_column('recipes', 'gross_profit')

        # Deleting field 'Recipes.food_cost'
        db.delete_column('recipes', 'food_cost')

        # Deleting field 'Recipes.vat'
        db.delete_column('recipes', 'vat')
    ...
    models = {
        ...
        u'recipe.recipes': {
            ...
            'food_cost': ('django.db.models.fields.IntegerField', [], {'max_length': '11', 'null': 'True'}),
            'gross_profit': ('django.db.models.fields.IntegerField', [], {'max_length': '11', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'vat': ('django.db.models.fields.IntegerField', [], {'max_length': '11', 'null': 'True'})
        },
