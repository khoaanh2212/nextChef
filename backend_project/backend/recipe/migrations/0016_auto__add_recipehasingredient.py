...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipe_has_ingredient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('custom_ingredient_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('generic_ingredient_id', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('measure', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('weight_in_gr', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2)),
            ('allergens', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'recipe', ['RecipeHasIngredient'])


    def backwards(self, orm):
        # Deleting model 'RecipeHasIngredient'
        db.delete_table('recipe_has_ingredient')
