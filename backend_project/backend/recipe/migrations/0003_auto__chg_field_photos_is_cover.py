...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photos.is_cover'
        db.alter_column('photos', 'is_cover', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photos.is_cover'
        db.alter_column('photos', 'is_cover', self.gf('django.db.models.fields.BooleanField')())
