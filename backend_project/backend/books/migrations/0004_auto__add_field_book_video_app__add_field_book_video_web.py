...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.video_app'
        db.add_column('books', 'video_app',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Book.video_web'
        db.add_column('books', 'video_web',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.video_app'
        db.delete_column('books', 'video_app')

        # Deleting field 'Book.video_web'
        db.delete_column('books', 'video_web')
    ...
    models = {
        ...
        u'books.book': {
            ...
            'video_app': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'video_web': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
