...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'books_booksale', (
            ...
            ('relation_type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1)),
            ('vendor', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'books', ['BookSale'])

        # Adding field 'Book.book_type'
        db.add_column('books', 'book_type',
                      self.gf('django.db.models.fields.CharField')(default='N', max_length=1),
                      keep_default=False)

        # Adding field 'Book.status'
        db.add_column('books', 'status',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)

        # Adding field 'Book.description'
        db.add_column('books', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Book.price'
        db.add_column('books', 'price',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'books_booksale')

        # Deleting field 'Book.book_type'
        db.delete_column('books', 'book_type')

        # Deleting field 'Book.status'
        db.delete_column('books', 'status')

        # Deleting field 'Book.description'
        db.delete_column('books', 'description')

        # Deleting field 'Book.price'
        db.delete_column('books', 'price')
