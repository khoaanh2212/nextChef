...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_types', (
        ...
        db.send_create_signal(u'notifications', ['NotificationType'])

        # Adding model 'Notification'
        db.create_table('notifications', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unread', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('chef', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['chefs.Chefs'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications_author', null=True, to=orm['chefs.Chefs'])),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe.Recipes'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notifications.NotificationType'], null=True, db_column='type', blank=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipe.Comments'], null=True, blank=True)),
        ))
        ...
        db.create_table('devices', (
            ...
            ('identificator', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('environment', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('chef', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='devices', null=True, to=orm['chefs.Chefs'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('notification_types')
