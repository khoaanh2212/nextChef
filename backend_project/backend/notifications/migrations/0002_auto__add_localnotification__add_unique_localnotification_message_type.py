...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalNotification'
        db.create_table('notifications_local', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('days', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ...
        db.send_create_signal(u'notifications', ['LocalNotification'])

        # Adding unique constraint on 'LocalNotification', fields ['message_type', 'language', 'days']
        db.create_unique('notifications_local', ['message_type', 'language', 'days'])


    def backwards(self, orm):
        # Removing unique constraint on 'LocalNotification', fields ['message_type', 'language', 'days']
        db.delete_unique('notifications_local', ['message_type', 'language', 'days'])

        # Deleting model 'LocalNotification'
        db.delete_table('notifications_local')
    ...
    models = {
        ...
        u'notifications.localnotification': {
            'Meta': {'unique_together': "(('message_type', 'language', 'days'),)", 'object_name': 'LocalNotification', 'db_table': "'notifications_local'"},
