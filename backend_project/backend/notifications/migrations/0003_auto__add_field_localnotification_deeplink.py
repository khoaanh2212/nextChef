...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalNotification.deeplink'
        db.add_column('notifications_local', 'deeplink',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalNotification.deeplink'
        db.delete_column('notifications_local', 'deeplink')
