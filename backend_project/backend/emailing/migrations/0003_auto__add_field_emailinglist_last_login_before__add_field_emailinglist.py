...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailingList.last_login_before'
        db.add_column('emailing_lists', 'last_login_before',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EmailingList.last_login_after'
        db.add_column('emailing_lists', 'last_login_after',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailingList.last_login_before'
        db.delete_column('emailing_lists', 'last_login_before')

        # Deleting field 'EmailingList.last_login_after'
        db.delete_column('emailing_lists', 'last_login_after')
    ...
    models = {
        ...
        'emailing.emailinglist': {
            ...
            'chef_type': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            'chefs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'emailing_lists'", 'blank': 'True', 'to': "orm['chefs.Chefs']"}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'ALL'", 'max_length': '3'}),
            'last_login_after': ('django.db.models.fields.IntegerField', [], {'default': '10000'}),
            'last_login_before': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
