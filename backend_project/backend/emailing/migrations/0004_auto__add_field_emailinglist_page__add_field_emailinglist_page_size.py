...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailingList.page'
        db.add_column('emailing_lists', 'page',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EmailingList.page_size'
        db.add_column('emailing_lists', 'page_size',
                      self.gf('django.db.models.fields.IntegerField')(default=1000000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailingList.page'
        db.delete_column('emailing_lists', 'page')

        # Deleting field 'EmailingList.page_size'
        db.delete_column('emailing_lists', 'page_size')
    ...
    models = {
        ...
        'emailing.emailinglist': {
            ...
            'last_login_after': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'last_login_before': ('django.db.models.fields.IntegerField', [], {'default': '10000'}),
            ...
            'page_size': ('django.db.models.fields.IntegerField', [], {'default': '1000000'})
        }
    }
