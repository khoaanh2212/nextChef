...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailingList.language'
        db.alter_column('emailing_lists', 'language', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'EmailingList.language'
        db.alter_column('emailing_lists', 'language', self.gf('django.db.models.fields.CharField')(max_length=2))
