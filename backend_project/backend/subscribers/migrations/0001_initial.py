...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubscriptionRecipe'
        db.create_table(u'subscribers_subscriptionrecipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'subscribers', ['SubscriptionRecipe'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SubscriptionRecipe'
        db.delete_table(u'subscribers_subscriptionrecipe')
    ...
    models = {
        ...
        u'subscribers.subscriptionrecipe': {
            'Meta': {'object_name': 'SubscriptionRecipe'},
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipe.Recipes']"}),
            'subscriber': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['subscribers.Subscriber']"})
        }
    }
