...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GenericIngredient.gross_price'
        db.delete_column('generic_ingredient', 'gross_price')

        # Deleting field 'GenericIngredient.waste'
        db.delete_column('generic_ingredient', 'waste')

        # Deleting field 'GenericIngredient.net_price'
        db.delete_column('generic_ingredient', 'net_price')


    def backwards(self, orm):
        # Adding field 'GenericIngredient.gross_price'
        db.add_column('generic_ingredient', 'gross_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2),
                      keep_default=False)

        # Adding field 'GenericIngredient.waste'
        db.add_column('generic_ingredient', 'waste',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GenericIngredient.net_price'
        db.add_column('generic_ingredient', 'net_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2),
                      keep_default=False)
