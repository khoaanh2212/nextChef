...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('custom_changes_ingredient', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))
    ...
    models = {
        u'costing.customchangesingredient': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '11', 'decimal_places': '3'}),
