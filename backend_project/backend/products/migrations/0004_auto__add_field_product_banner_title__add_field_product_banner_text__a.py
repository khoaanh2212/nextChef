...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.banner_title'
        db.add_column('products', 'banner_title',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.banner_text'
        db.add_column('products', 'banner_text',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.banner_image'
        db.add_column('products', 'banner_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.banner_enabled'
        db.add_column('products', 'banner_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.banner_title'
        db.delete_column('products', 'banner_title')

        # Deleting field 'Product.banner_text'
        db.delete_column('products', 'banner_text')

        # Deleting field 'Product.banner_image'
        db.delete_column('products', 'banner_image')

        # Deleting field 'Product.banner_enabled'
        db.delete_column('products', 'banner_enabled')
    ...
    models = {
        ...
        u'products.product': {
            ...
            'banner_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'banner_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'banner_text': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'banner_title': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'recipe': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'products'", 'symmetrical': 'False', 'to': u"orm['recipe.Recipes']"}),
